...
const projectsData = [
  ...
  },
  {
    ...
    description: { ru: 'Лендинг ресторана Grut: коктейльная карта, одна цена 999₽.', en: 'Grut restaurant landing: cocktail menu, single price 999₽.' },
    image: 'https://placehold.co/600x340/1a1a1a/ffffff?text=Grut',
    tech: ['HTML', 'CSS', 'JavaScript'],
    tags: ['javascript'],
    linkCode: '#',
